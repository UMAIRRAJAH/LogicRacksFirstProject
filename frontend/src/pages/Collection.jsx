  ...
  />
    ...
    <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
      <p className='flex-gap-2'>
        <input className='w-3'type="checkbox" value={'man'} onChange={toggleCategory}/>Men
      </p>
            <p className='flex-gap-2'>
        <input className='w-3'type="checkbox" value={'woman'}  onChange={toggleCategory}/>Women
      </p>
            <p className='flex-gap-2'>
        ...
        <div className={`border border-gray-300 pl-5 py-3  mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
    <p className='mb-3 text-sm font-medium'>TYPE(Kinds)</p>
    <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
      <p className='flex-gap-2'>
        <input className='w-3'type="checkbox" value={'shalwar'} onChange={toggleSubCategory}/>ShalwarQameez
      </p>
            <p className='flex-gap-2'>
        ...
        <input className='w-3'type="checkbox" value={'shoes'} onChange={toggleSubCategory}/>Shoes
          ...
          <p className='flex-gap-2'>
        <input className='w-3'type="checkbox" value={'sweater'} onChange={toggleSubCategory}/>Sweater
      </p>
       <p className='flex-gap-2'>
